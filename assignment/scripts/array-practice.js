...
let favoriteFoods = ['Corn','Gyros', 'Beef Curry', 'Sandwiches']
...
console.log('The number of favorite foods I have is:', favoriteFoods.length);
...
console.log('Added new favorite food', favoriteFoods);
...
console.log('My new selection of favorite food is', favoriteFoods);

// 4.f (STRETCH) TODO: Sort your favoriteFoods array
//     in reverse alphabetical order. Log the array.
let alphaFoods = favoriteFoods.sort();
console.log(alphaFoods);
...
let mstrArray = [animalArray.concat(favoriteFoods)];
